...
class Home extends Component {
  ...
  render() {
    console.log(JSON.stringify(PropTypes.object, null, 4));
    console.log(JSON.stringify("Home.bak", null, 4));
    // SimpleStorage Vars
    ...
    //Shop
    var shopAddress = this.props.drizzleStatus.initialized ? this.contracts.TokenShop.methods.getAddress.data() : 'Loading...'
    ...
    return(
      <main className="container">
        <div className="pure-g">
          ...
          <div className="pure-u-1-1">
            <h2>SimpleStorage</h2>
            <p><strong>Stored Value01</strong>: {storedData}</p>
